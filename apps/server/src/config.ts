...
export const config = Object.freeze({
  ...
  ruvNewsCategories: required("RUV_NEWS_CATEGORIES").split(",").map(value => value.trim()),
  ...
  ruvArchiveSearchTerms: required("RUV_ARCHIVE_SEARCH_TERMS").split(",").map(value => value.trim()).filter(Boolean),
