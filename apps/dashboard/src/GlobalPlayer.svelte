...
<section class:fullscreen={media.fullscreen} class="global-player" aria-label="Alþjóðlegur spilari">
...
<style>
  ...
  .player-visual{width:72px;height:72px;position:relative;overflow:hidden;border:1px solid var(--hero-border);border-radius:10px;background:var(--raised);display:grid;place-items:center}.player-visual video,.player-visual img{width:100%;height:100%;object-fit:cover}.player-visual.audio-art img{object-fit:contain;padding:5px}.loading{position:absolute;animation:spin .8s linear infinite;color:white}
  .player-copy{min-width:0;display:grid;grid-template-columns:1fr auto}.player-copy>span{font-size:10px;color:var(--primary);font-weight:750}.player-copy>strong{grid-column:1/3;font-size:17px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;margin:2px 0}.player-copy>small{grid-column:1/3;color:var(--muted);font-size:10px}.player-copy>small b{font-weight:500;margin-left:8px}.timeline{grid-column:1/3;margin-top:8px;display:grid;grid-template-columns:42px 1fr 42px;align-items:center;gap:8px;font-size:9px;color:var(--muted)}.timeline i{height:3px;background:var(--border);border-radius:99px;overflow:hidden}.timeline i b{display:block;height:100%;background:var(--primary)}
  ...
  .global-player.fullscreen{position:fixed;inset:0;width:auto;height:100dvh;padding:36px 42px;z-index:50;grid-template-columns:minmax(340px,1fr) auto minmax(430px,auto);align-content:end;background:var(--hero-tone)}.fullscreen .player-visual{position:absolute;inset:0;width:100%;height:100%;border:0;border-radius:0}.fullscreen .player-visual video{object-fit:contain}.fullscreen .player-copy,.fullscreen .transport,.fullscreen .player-tools{position:relative;z-index:1}.fullscreen .player-copy>strong{font-size:31px}.fullscreen .player-panel{bottom:120px}
  @keyframes spin{to{transform:rotate(360deg)}}
  @media(max-width:1200px){.global-player{padding-inline:20px;grid-template-columns:64px minmax(180px,1fr) auto}.player-tools{display:none}.player-visual{width:62px;height:62px}}
