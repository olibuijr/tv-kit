<script lang="ts">
  ...
  import { contentIsStale, deriveRuvNow, EMPTY_DASHBOARD_CONTENT, eventProgress, fetchDashboardContent, formatClock, formatDate, formatDuration, formatScheduleTime, formatTime, relativeTime } from "../../../packages/protocol/content";
