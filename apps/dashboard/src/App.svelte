<script lang="ts">
  ...
  import { tvServerUrl, tvServerWebSocketUrl, type DashboardContent, type HomeState, type RuvNewsArticle, type Station } from "../../../packages/protocol";
  import { articleParagraphs, contentIsStale, deriveRuvNow, EMPTY_DASHBOARD_CONTENT, eventProgress, fetchDashboardContent, fetchNewsArticle, formatClock, formatDate, formatDuration, formatScheduleTime, formatTime, relativeTime } from "../../../packages/protocol/content";
