...
<style>
  ...
  main{max-width:1060px;margin:auto;padding:16px 20px 106px;display:flex;flex-direction:column;gap:14px}.chat-mode{height:calc(100dvh - 76px);min-height:0;overflow:hidden;padding-bottom:90px}.chat-mode .agent-chat{min-height:0}.panel{background:var(--surface);border:1px solid var(--border);border-radius:14px;overflow:hidden;box-shadow:var(--shadow-card)}.panel-heading{height:52px;padding:0 15px;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid var(--border)}.panel-heading>div{display:flex;align-items:center;gap:8px}.panel-heading h2{font-size:14px;margin:0}.panel-heading>span{font-size:10px;color:var(--muted)}.panel-heading button{height:44px;border:0;background:none;display:flex;align-items:center;gap:4px;color:var(--primary);font-size:11px}
