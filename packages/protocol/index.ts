...
export type MediaKind = "radio" | "music" | "podcast" | "video" | "movie" | "tv";
...
export type Command =
  | { type: "command"; action: "toggle-play" | "toggle-mute" | "back" | "power" | "media-next" | "media-previous" | "toggle-favorite" | "cast-stop" }
  | { type: "command"; action: "volume" | "channel" | "radio" | "radio-favorite" | "seek" | "playback-rate" | "media-progress" | "ruv-program"; value: number }
  | { type: "command"; action: "key" | "subtitle" | "audio-track" | "player-panel" | "player-status" | "ruv-channel" | "ruv-episode" | "tv-favorite"; value: string }
...
export type RuvProgramResponse = { program: RuvProgram; episodes: RuvEpisode[] };
