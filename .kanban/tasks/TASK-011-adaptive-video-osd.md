...
- [x] OSD text and icons maintain accessible contrast over representative light, dark, and mixed video backgrounds without obscuring more video than necessary.
- [x] The OSD smoothly slides down and out after 10 seconds of continuous playback.
- [x] The hide timer starts or resets when playback starts, the station/media changes, or the OSD is reopened, and does not incorrectly expire while playback is paused.
...
Implemented in the existing fullscreen player: high-contrast shadow/scrim styling, a playback-aware 10-second timeout, slide exit, and panel-driven reopening. Runtime visual verification remains pending.
